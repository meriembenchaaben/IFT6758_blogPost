...
The models have a better generalization performance on regular seasons (according to our evaluation on the validation and test sets) as compared to playoffs.
