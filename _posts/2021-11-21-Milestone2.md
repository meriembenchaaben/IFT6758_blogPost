...
<img src="/assets/milestone2/AllFigures.png" alt="" style="display:block;width:100%;margin:0;padding:0;">
...
Taking into consideration all the previous plots, we decide to select the XGBoost model that takes as input only both features
distanceFromNet & angle in order to use it in the final phase; Testinng.

Link to best Model registred: 
-https://www.comet.ml/meriembchaaben/model-registry/xgboost-task5-model
