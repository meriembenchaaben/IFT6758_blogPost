...
Perhaps if we wanted to further improve the accuracy of our models, we should consider creating additonal, domain-epertise-based features, instead of attempting to remove from the existing feature set. 
